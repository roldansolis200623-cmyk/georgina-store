...
const initialProducts: Product[] = [
  ...
  {
    id: 6,
    name: 'Lampara de Pie Industrial',
    category: 'iluminacion',
    price: 189990,
    originalPrice: 239990,
    description: 'Lampara de pie estilo industrial con acabado en negro mate.',
    badge: 'oferta',
    stock: 4,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    category: 'muebles',
    price: 349990,
    description: 'Sillon individual con diseno nordico. Tela bouclé color crema.',
    badge: 'exclusivo',
    stock: 2,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  },
  {
    ...
    category: 'iluminacion',
    price: 69990,
    description: 'Aplique de pared LED con diseno minimalista. Luz calida.',
    badge: 'nuevo',
    stock: 20,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  ...
  {
    id: 12,
    name: 'Velador de Mesa',
    category: 'iluminacion',
    price: 49990,
    description: 'Velador de mesa con pantalla de tela. Ideal para dormitorios.',
    stock: 18,
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
