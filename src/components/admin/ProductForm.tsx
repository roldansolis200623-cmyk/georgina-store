...
export function ProductForm({ product, onClose, onSuccess }: ProductFormProps) {
  ...
  const validate = () => {
    ...
    if (!images.some(img => img)) newErrors.images = 'Al menos una imagen es requerida';
    setErrors(newErrors);
    ...
    <div className="h-full flex flex-col">
      ...
      <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-6">
        <div className="space-y-4">
          <h3 className="font-medium text-primary border-b pb-2">Información Básica</h3>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: Sofá Moderno 3 Cuerpos"
            />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Ej: 10"
            />
            <p className="text-xs text-grey mt-1">Deja vacío para stock ilimitado</p>
          </div>
        </div>

        <div className="space-y-4">
          <h3 className="font-medium text-primary border-b pb-2">Información Adicional</h3>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-secondary outline-none"
              placeholder="Ej: sofá moderno, sala, living"
            />
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="font-medium text-primary border-b pb-2">
            ...
            {errors.images && <span className="text-red-500 text-sm ml-2">* {errors.images}</span>}
          </h3>
          <p className="text-sm text-grey">Puedes agregar hasta 4 imágenes. La primera será la principal.</p>
      ...
      <div className="p-4 border-t flex gap-3">
        ...
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-secondary text-white rounded-xl hover:bg-accent transition-colors"
        >
